...
export interface MainContentProps {
  ...
  onInputFocusChange: (focused: boolean) => void; onMenuClick: () => void; onNavigateToSession: (targetSessionId: string, options?: SessionNavigationOptions) => void; onNewSession: (project: Project) => void; onSessionEstablished: (sessionId: string, context: SessionEstablishedContext) => void; onSessionIdle: MarkSessionIdle; onSessionProcessing: MarkSessionProcessing; onShowSettings: (tab?: SettingsMainTab) => void; sendMessage: (message: unknown) => void; setActiveTab: TabSetter;
}
