            ...
            {message.isToolUse ? (
              <>
                <div className="flex flex-col">
                  <div className="flex flex-col">
                    <Markdown className="prose prose-sm max-w-none dark:prose-invert [&_pre]:max-w-none [&_table]:max-w-none">
                  ...
                  effectiveToolResult.isError ? (
                    ...
                    >
                      ...
                      <div className="relative text-sm text-red-900 dark:text-red-100">
                        <Markdown className="prose prose-sm prose-red max-w-none dark:prose-invert [&_pre]:max-w-none [&_table]:max-w-none">
              ...
              <Reasoning defaultOpen={false}>
                <ReasoningTrigger />
                <ReasoningContent>
                  <Markdown className="prose prose-sm prose-gray max-w-none dark:prose-invert [&_pre]:max-w-none [&_table]:max-w-none">
                    {message.content}
                  </Markdown>
