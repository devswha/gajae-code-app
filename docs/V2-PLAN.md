...
> **현황 재확인 (2026-09-05):** 아래 Phase 7은 7월에 작성한 준비 체크리스트다.
> 공개 배포는 이미 진행됐고, 2026-09-03 beta.7·beta.8의 Developer ID 서명과
> 공증 DMG가 배포됐다. 아래의 "보류" 상태와 미체크 항목을 현재 작업 목록으로
> 해석하지 않는다. 실제 재개 순서와 외부 의존성은
> [세션 인계 문서](V2-SESSION-HANDOFF.md)의 현재 후속 작업을 따른다.
