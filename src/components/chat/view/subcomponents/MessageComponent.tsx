            ...
            {message.isToolUse ? (
              <>
                <div className="flex flex-col">
                  <div className="flex flex-col">
                    <Markdown className="prose prose-base max-w-none dark:prose-invert prose-headings:max-w-[90ch] prose-blockquote:max-w-[90ch] prose-li:max-w-[90ch] [&_pre]:max-w-none [&_table]:max-w-none">
