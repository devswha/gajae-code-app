import { WS_OPEN_STATE } from '@/modules/websocket/services/websocket-state.service.js'; // shared transport constant
...
export class WebSocketWriter { // name is part of the module's public surface
